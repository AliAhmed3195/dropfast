...
const ModernStoreTemplate: React.FC<ModernStoreTemplateProps> = ({ store }) => {
  ...
  return (
    <div className="template-modern min-h-screen bg-white">
      {/* Header */}
      ...
      {/* Featured Products */}
      {templateConfig?.hasFeatured && store.featuredProducts && store.featuredProducts.length > 0 && (
                ...
                <div key={product.id} className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
                  ...
                  <div className="p-4">
                    ...
                    <Link
                      ...
                      className="mt-3 inline-block bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 transition-colors w-full text-center"
                    >
                      View Details
                    </Link>
                  </div>
      ...
      {templateConfig?.hasNewsletter && (
        <section className="bg-red-600 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-red-100 mb-8">Subscribe to our newsletter for the latest updates and offers</p>
